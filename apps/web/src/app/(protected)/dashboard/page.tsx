...
const actionLabels: Record<string, string> = {
  ...
  GOOGLE_DRIVE_CONNECTED: "Armazenamento em nuvem conectado",
  GOOGLE_DRIVE_DISCONNECTED: "Armazenamento em nuvem desconectado",
  STORAGE_CONNECTED: "Armazenamento em nuvem conectado",
  STORAGE_DISCONNECTED: "Armazenamento em nuvem desconectado",
  STORAGE_FOLDER_CREATE: "Pasta de armazenamento criada",
  GOOGLE_DRIVE_FOLDER_CREATE: "Pasta de armazenamento criada",
